...
EXCLUDE_DISTRICTS = [          # 需求區域含這些行政區不搶（2026-08-14 加，偏遠區；2026-08-26 加大社區；2026-09-04 加旗山區）
    "美濃區", "六龜區", "岡山區", "路竹區", "大寮區", "橋頭區", "杉林區", "燕巢區", "林園區", "梓官區", "大社區",
    "旗山區",
]
...
EXCLUDE_TYPES = ["公寓", "土地", "套房"]      # 這些類型不搶；類型空白 / "-" 不受影響照收
