...
1. **AA1070116 補發待驗**（07-27 15:00 被 FB 500 打掉那件，崑庭敦品／新興區八德一路／1988 萬）。當時的 Notion 待發列已手動 archive 掉，**17:00 那班應該會重新抓到它並發出去**。下次開工先看 Notion 有沒有新的一列且 `粉專貼文連結` 有值；有就把這條刪掉。沒發到的話看 LINE 有沒有收到新告警。
