...
4. **PG0092558（仁武預售）的 KEIS 廣告追蹤還缺一筆**：2026-07-29 17:00 那班 FB 發了但 KEIS 建檔失敗（見下方門檻改版），使用者說先放著、等他確認後再指示怎麼補。要補的話連結是 `https://buy.yungching.com.tw/house/7454949`。
   （同班次的 YG0092410 已處理完畢：FB 貼文已刪、Notion 標下架，KEIS 廣告追蹤本來就沒建成功，不用關。）
