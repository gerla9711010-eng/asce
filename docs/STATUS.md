...
3. **線 B 手動待辦：花賞那篇粉專文要自己刪**。網址 `facebook.com/permalink.php?story_fbid=pfbid02trm2JG…&id=61590105023923`。那篇不在「買房不費力,賣房好給力」（`1041868522352339`）粉專上——拿粉專權杖去問 `61590105023923`，FB 回「不存在或沒權限」，所以系統永遠刪不掉它，只能人工處理。刪完這條就可以拿掉。
