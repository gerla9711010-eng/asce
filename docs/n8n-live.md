# n8n 線上現況（2026-09-14 23:41 自動產生）
...
| 狀態 | 名稱 | 檔案 | 節點 | 最近執行 |
|---|---|---|---|---|
| 🟢 | KEIS 待聯絡提醒 | `keis-contact-reminder.json` | 6 | 2026-09-14T01:00 success |
| 🟢 | KEIS 心跳接收（極簡） | `KEIS-心跳接收極簡.json` | 1 | 2026-09-14T15:37 success |
| 🟢 | KEIS 情資週報 | `market-report-notify.json` | 7 | — |
| 🟢 | KEIS 戰果查詢 | `keis-battle-report.json` | 5 | — |
| 🟢 | KEIS 搶單 LINE 通知 | `keis-grab-notify.json` | 4 | 2026-09-14T00:01 success |
...
| 🟢 | 廣告v3 下架偵測線 | `yc-v3-removal.json` | 29 | 2026-09-14T14:00 success |
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 63 | 2026-09-14T11:00 success |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | — |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 34 | 2026-09-14T11:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-09-14T11:00 success |
| 🟢 | 系統錯誤 LINE 告警 | `系統錯誤-LINE-告警.json` | 4 | — |
| 🟢 | 自動簽到 LINE 通知 | `clockin-notify.json` | 3 | 2026-09-13T01:42 success |
