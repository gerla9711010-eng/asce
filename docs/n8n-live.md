# n8n 線上現況（2026-08-07 17:06 自動產生）
...
| 🟢 | KEIS 心跳檢查 | `keis-heartbeat-check.json` | 5 | 2026-08-07T09:05 success |
...
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 61 | 2026-08-07T09:00 waiting |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | — |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 28 | 2026-08-07T07:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-08-07T09:00 success |
...
| 🟢 | 靜默失敗巡邏 | `靜默失敗巡邏.json` | 7 | 2026-08-07T09:00 success |
