# n8n 線上現況（2026-07-28 17:10 自動產生）
...
| 🟢 | KEIS 心跳檢查 | `keis-heartbeat-check.json` | 5 | 2026-07-28T09:06 success |
...
| 🟢 | LINE 指令分流器 v3 | `line-command-router.json` | 14 | 2026-07-28T02:30 success |
...
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 55 | 2026-07-28T07:00 success |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | 2026-07-22T14:02 success |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 24 | 2026-07-28T07:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-07-28T09:00 success |
