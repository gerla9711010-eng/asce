# n8n 線上現況（2026-08-07 21:52 自動產生）
...
| 狀態 | 名稱 | 檔案 | 節點 | 最近執行 |
|---|---|---|---|---|
| 🟢 | KEIS 待聯絡提醒 | `keis-contact-reminder.json` | 4 | 2026-08-07T01:00 success |
| 🟢 | KEIS 心跳檢查 | `keis-heartbeat-check.json` | 5 | 2026-08-07T13:47 success |
...
| 🟢 | KEIS 搶單 LINE 通知 | `keis-grab-notify.json` | 3 | 2026-08-07T01:52 success |
...
| 🟢 | 廣告v3 下架偵測線 | `yc-v3-removal.json` | 26 | 2026-08-07T01:30 success |
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 61 | 2026-08-07T11:00 success |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | — |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 28 | 2026-08-07T11:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-08-07T11:00 success |
| 🟢 | 系統錯誤 LINE 告警 | `系統錯誤-LINE-告警.json` | 3 | 2026-08-06T00:00 success |
| 🟢 | 自動簽到 LINE 通知 | `clockin-notify.json` | 3 | 2026-08-06T01:35 success |
| 🟢 | 行事曆建立器 | `line-calendar-create.json` | 13 | 2026-08-01T03:07 success |
| 🟢 | 靜默失敗巡邏 | `靜默失敗巡邏.json` | 7 | 2026-08-07T13:30 success |
