# n8n 線上現況（2026-07-30 16:27 自動產生）
...
| 狀態 | 名稱 | 檔案 | 節點 | 最近執行 |
|---|---|---|---|---|
| 🟢 | KEIS 待聯絡提醒 | `keis-contact-reminder.json` | 4 | 2026-07-30T01:00 success |
| 🟢 | KEIS 心跳檢查 | `keis-heartbeat-check.json` | 5 | 2026-07-30T08:25 success |
| 🟢 | KEIS 情資週報 | `market-report-notify.json` | 7 | 2026-07-28T12:40 success |
| 🟢 | KEIS 戰果查詢 | `keis-battle-report.json` | 5 | 2026-07-30T00:25 success |
| 🟢 | KEIS 搶單 LINE 通知 | `keis-grab-notify.json` | 3 | 2026-07-30T00:56 success |
| 🟢 | LINE 指令分流器 v3 | `line-command-router.json` | 15 | 2026-07-30T00:25 success |
| 🟢 | 圖片分流器（LINE 傳圖自動分類） | `line-image-dispatcher.json` | 9 | 2026-07-28T02:30 success |
| 🟢 | 客戶建檔器 | `line-customer-create.json` | 13 | 2026-07-16T10:15 success |
| 🟢 | 廣告v3 下架偵測線 | `yc-v3-removal.json` | 21 | 2026-07-30T00:00 success |
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 59 | 2026-07-30T07:00 success |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | 2026-07-22T14:02 success |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 24 | 2026-07-30T07:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-07-30T05:00 success |
| 🟢 | 系統錯誤 LINE 告警 | `系統錯誤-LINE-告警.json` | 3 | 2026-07-28T12:05 success |
| 🟢 | 自動簽到 LINE 通知 | `clockin-notify.json` | 3 | 2026-07-30T01:31 success |
| 🟢 | 行事曆建立器 | `line-calendar-create.json` | 13 | 2026-07-28T02:30 success |
| 🟢 | 靜默失敗巡邏 | `靜默失敗巡邏.json` | 7 | 2026-07-30T08:00 success |
