# n8n 線上現況（2026-08-26 14:48 自動產生）
...
| 狀態 | 名稱 | 檔案 | 節點 | 最近執行 |
|---|---|---|---|---|
| 🟢 | KEIS 待聯絡提醒 | `keis-contact-reminder.json` | 4 | 2026-08-26T01:00 success |
| 🟢 | KEIS 心跳接收（極簡） | `KEIS-心跳接收極簡.json` | 1 | 2026-08-26T06:45 success |
| 🟢 | KEIS 情資週報 | `market-report-notify.json` | 7 | — |
| 🟢 | KEIS 戰果查詢 | `keis-battle-report.json` | 5 | 2026-08-15T04:21 success |
| 🟢 | KEIS 搶單 LINE 通知 | `keis-grab-notify.json` | 4 | 2026-08-26T05:05 success |
...
| 🟢 | 廣告v3 下架偵測線 | `yc-v3-removal.json` | 28 | 2026-08-26T01:30 success |
| 🟢 | 廣告v3 掃描發文線 | `yc-v3-scan-publish.json` | 63 | 2026-08-26T05:00 success |
| 🟢 | 廣告v3 煞車（停） | `yc-v3-stop.json` | 9 | — |
| 🟢 | 廣告v3 重發輪替線 | `yc-v3-repost.json` | 30 | 2026-08-26T05:30 success |
| 🟢 | 查專員電話（展售系統） | `查專員電話展售系統.json` | 7 | 2026-08-26T05:00 success |
| 🟢 | 系統錯誤 LINE 告警 | `系統錯誤-LINE-告警.json` | 4 | 2026-08-26T03:00 success |
